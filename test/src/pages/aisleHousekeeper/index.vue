...
export default {
    ...
    methods:{
        ...
        small(i){
            ...
            //         }
            //         axiosPost("/cjpay/getBindCardExist",data)
            //         .then(res=>{
            //             if(res.data.success){
            ...
            //                 .then(res=>{
            //                     console.log(res,"11")
            //                     if(res.data.success){  //绑卡/home/xsbinding
            //                         this.$router.push({
            //                                 path:'/home/xsbinding',
            //                             query:{
            //                                 info:i
        ...
        large(i){
                    let datas={
                      ...
                      .then(res=>{
                          if(res.data.success){
                              let data={
                                bank_card_no:i.cardNo
                            }
                            axiosPost("/zsdhpay/getZSDHBindCard",data)
                            .then(res=>{
                                if(res.data.success){
